            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form  action="{{ route('pesticide.update',[ 'pesticide' => $pesticide->id ])}}" method="POST" enctype="multipart/form-data" class="col-12 was-validated">
                            @method('PATCH')
                            @csrf
                 
                            @include('plantetc/pesticide/form_edit')
