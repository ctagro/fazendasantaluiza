...
<ul class="navbar-nav iq-main-menu"  id="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="{{route('plantetc.dashboard')}}">
            <i class="icon">
...
<li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu" role="button" aria-expanded="false" aria-controls="horizontal-menu">
        ...
        <span class="item-name">Vyia</span>
        <i class="right-icon">
    ...
    <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar">
        ...
        <li class=" nav-item ">
            <a class="nav-link " href="{{route('umidade.index')}}">
                <i class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                        <g>
                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <span class="item-name">Umidade</span>
            </a>
        </li>
        <li class=" nav-item ">
            <a class="nav-link" href="{{route('temperatura.create')}}">
                ...
                <i class="sidenav-mini-icon"> D </i>                   
                <span class="item-name">Temperatura1</span>
            </a>
        </li>
        ...
        <li class="nav-item ">
            <a class="nav-link" href="">
                ...
                <span class="item-name">Localizações</span>
            </a>
        </li>
    </ul>
</li>
...
<!--- Fim  Robocar -->
 ...
 <li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu" role="button" aria-expanded="false" aria-controls="horizontal-menu">
        ...
        <span class="item-name">Cotações Ceasa</span>
        <i class="right-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
    ...
    <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar">
        ...
        <li class=" nav-item ">
            <a class="nav-link " href="{{route('ceasa_research.consult')}}">
                ...
                <i class="sidenav-mini-icon"> D </i>
                <span class="item-name">Pesquisa</span>
            </a>
        </li>
        <li class=" nav-item ">
        ...
        <li class="nav-item ">
            <a class="nav-link" href="">
                ...
                <i class="sidenav-mini-icon"> B </i>
                <span class="item-name">Estatisticas</span>
            </a>
        </li>
    </ul>
...
<span class="item-name">Pragas / doenças</span>
<i class="right-icon">
    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
    </svg>
...
<ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar">
    <li class="nav-item ">
        ...
        <i class="sidenav-mini-icon"> H </i>
        <span class="item-name"> Culturas </span>
        </a>
    </li>
    <li class=" nav-item ">
        <a class="nav-link " href="{{route('disease.index')}}">
            ...
            <i class="sidenav-mini-icon"> D </i>
            <span class="item-name">Doenças</span>
        </a>
    </li>
    <li class="nav-item ">
        <a class="nav-link" href="{{route('crop_variety.index')}}">
        <i class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                    <g>
                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
        ...
        <i class="sidenav-mini-icon"> H </i>
        <span class="item-name"> Variedades de cultura</span>
        </a>
    </li>

    <li class="nav-item ">
        <a class="nav-link" href="{{route('activePrinciple.index')}}">
        <i class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                    <g>
                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
        ...
        <i class="sidenav-mini-icon"> H </i>
        <span class="item-name"> Princípios Ativo</span>
        </a>
    </li>
    ...
    <li class="nav-item ">
        ...
        <i class="sidenav-mini-icon"> H </i>
        <span class="item-name">Defensivos</span>
        </a>
    </li>
</ul>

<!------ Fim Pragas e Doenças   -->
...
<!------ Inicio Auxiliares   -->
    ...
    <span class="item-name">Auxiliares</span>
    <i class="right-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
        </svg>
    ...
    <li class="nav-item ">
        ...
        <i class="sidenav-mini-icon"> H </i>
        <span class="item-name"> Classe Agronômica </span>
        </a>
    </li>

    <li class="nav-item ">
        <a class="nav-link" href="{{route('formulationType.index')}}">
        <i class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                    <g>
                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
        ...
        <i class="sidenav-mini-icon"> H </i>
        <span class="item-name"> Tipo de Formulação </span>
        </a>
    </li>
    ...
    <li class="nav-item ">
        <a class="nav-link" href="{{route('applicationMode.index')}}">
        <i class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                    <g>
                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
    ...
    <li class="nav-item ">
        ...
        <i class="sidenav-mini-icon"> H </i>
        <span class="item-name"> Tipo de Controle </span>
        </a>
    </li>
...
<li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu" role="button" aria-expanded="false" aria-controls="horizontal-menu">
        ...
        <span class="item-name">Robocar</span>
        <i class="right-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
...
---------    Hope UI   ---
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu" role="button" aria-expanded="false" aria-controls="horizontal-menu">
            ...
            <span class="item-name">Estilo de Menu....</span>
            <i class="right-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
