                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6"> 
                            ...
                            <input type="text" name="name" value="{{old('name') ?? $defensivo->name }}" class="form-control form-control-sm" placeholder="Defensivo">
                            @if($errors->has('name'))
                    ...
                    <div class="form-group col-sm-6"> 
                        ...
                        <select name="manufacturer_id" class="form-select form-select-sm mb-3" id="manufacturer_id" aria-label=".form-select-lg example" required>
                           ...
                           <option value="{{$manufacturer->id}}" {{ $manufacturer->id == $defensivo->manufacturer_id ? 'selected' : ''}}>{{$manufacturer->name}} </option> 
                                @endforeach
                        </select> 
...
<--================Principio Ativo ---
                ...
                -->           
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4"> 
                            ...
                            <select name="agronomicClass_id" class="form-select form-select-sm mb-3" id="agronomicClass_id" aria-label=".form-select-lg example" required>
                               ...
                               @foreach($agronomicClasses as $agronomicClass)    
                                        <option value="{{$agronomicClass->id}}" {{ $agronomicClass->id == $defensivo->agronomicClass_id ? 'selected' : ''}}>{{$agronomicClass->name}} </option>                 
                                    @endforeach
                            </select> 
                        ...
                        <select name="formulationType_id" class="form-select form-select-sm mb-3" id="agronomicClass_id" aria-label=".form-select-lg example" required>
                           ...
                           <option value="{{$formulationType->id}}" {{ $formulationType->id == $defensivo->formulationType_id ? 'selected' : ''}}>{{$formulationType->name}} </option> 
                                @endforeach
                        </select> 
                    ...
                    <div class="form-group col-sm-4 ">
                            ...
                            <select name="applicationMode_id" class="form-select form-select-sm mb-3" id="agronomicClass_id" aria-label=".form-select-lg example" required>
                               ...
                               <option value="{{$applicationMode->id}}" {{ $applicationMode->id == $defensivo->applicationMode_id ? 'selected' : ''}}>{{$applicationMode->name}} </option> 
                                    @endforeach
                            </select> 
                    ...
                    <div class="row">
                        <div class="form-group col-sm-4"> 
                            ...
                            <input type="number" name="dosage" value="{{old('dosage') ?? $defensivo->dosage }}" class="form-control form-control-sm" placeholder="Dosagem">
                        ...
                        <div class="form-group col-sm-4"> 
                                ...
                                <input type="text" name="unity" value="{{old('unity') ?? $defensivo->unity }}" class="form-control form-control-sm" placeholder="Unidade">
                                @if($errors->has('unity'))
                            ...
                            <div class="form-group col-sm-4 ">
                                ...
                                <select name="toxicologicalClass_id" class="form-select form-select-sm mb-3" id="agronomicClass_id" aria-label=".form-select-lg example" required>
                                   ...
                                   <option value="{{$toxicologicalClass->id}}" {{ $toxicologicalClass->id == $defensivo->toxicologicalClass_id ? 'selected' : ''}}>{{$toxicologicalClass->name}} </option> 
                                        @endforeach
                                </select> 
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4 ">
                            ...
                            <select name="grupo_quimico_id" class="form-select form-select-sm mb-3" id="agronomicClass_id" aria-label=".form-select-lg example" required>
                               ...
                               <option value="{{$grupo_quimico->id}}" {{ $grupo_quimico->id == $defensivo->grupo_quimico_id ? 'selected' : ''}}>{{$grupo_quimico->name}} </option> 
                                    @endforeach
                            </select> 
                    ...
                    <div class="form-group col-sm-4 ">
                        ...
                        <select name="actionSite_id" class="form-select form-select-sm mb-3" id="agronomicClass_id" aria-label=".form-select-lg example" required>
                           ...
                           <option value="{{$actionSite->id}}" {{ $actionSite->id == $defensivo->actionSite_id ? 'selected' : ''}}>{{$actionSite->name}} </option> 
                                @endforeach
                        </select> 
                    ...
                    <div class="form-group col-sm-4 ">
                        ...
                        <select name="modeOperation_id" class="form-select form-select-sm mb-3" id="modeOperation_id" aria-label=".form-select-lg example" required>
                           ...
                           <option value="{{$modeOperation->id}}" {{ $modeOperation->id == $defensivo->modeOperation_id ? 'selected' : ''}}>{{$modeOperation->name}} </option> 
                                @endforeach
                        </select> 
                ...
                <div class="form-group">
                    ...
                    <select name="actuationMechanism_id" class="form-select form-select-sm mb-3" id="actuationMechanism_id" aria-label=".form-select-lg example" required>
                       ...
                       <option value="{{$actuationMechanism->id}}" {{ $actuationMechanism->id == $defensivo->actuationMechanism_id ? 'selected' : ''}}>{{$actuationMechanism->name}} </option> 
                            @endforeach
                    </select> 
                    ...
                    <div class="row">
                        <div class="form-group col-sm-4"> 
                            ...
                            <input type="number" name="applicationRange" value="{{old('applicationRange') ?? $defensivo->applicationRange }}" class="form-control form-control-sm" >
                            ...
                            <div class="form-group col-sm-4"> 
                                ...
                                <input type="number" name="numberApplications" value="{{old('numberApplications') ?? $defensivo->numberApplications }}" class="form-control form-control-sm" >
                    ...
                    <div class="form-group">
                        ...
                        @if ($defensivo->image != null)
                        <img src="{{ asset('storage/defensivo/'.$defensivo->image)}}" 
                    ...
                    <div>
                        ...
                        @else
                            <div class="form-group">
                                <label>Ativo: {{$defensivo->in_use}} </label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="note" value="{{old('note') ?? $defensivo->note }}" class="form-control form-control-sm" >
                    </div>
