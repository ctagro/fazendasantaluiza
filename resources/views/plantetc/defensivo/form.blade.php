...
<!--================Principio Ativo -->
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4"> 
                                    ...
                                    <input type="number" name="dosage" value="{{old('dosage') ?? $defensivo->dosege }}" class="form-control form-control-sm" placeholder="Dosagem">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4"> 
                                    ...
                                    <input type="number" name="applicationRange" value="{{old('applicationRange') ?? $defensivo->dosege }}" class="form-control form-control-sm" placeholder="Dosagem">
                                    ...
                                    <div class="form-group col-sm-4"> 
                                        ...
                                        <input type="number" name="numberApplications" value="{{old('numberApplications') ?? $defensivo->dosege }}" class="form-control form-control-sm" placeholder="Dosagem">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="note" value="{{old('note') ?? $defensivo->note }}" class="form-control form-control-sm" placeholder="Nota">
                            </div>
