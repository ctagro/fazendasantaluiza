            ...
            <div class="col">
              ...
              <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{old('name') ?? $chemicalGroup->name }}" class="form-control form-control-sm" placeholder="Nome">
                                @if($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="description" value="{{old('name') ?? $chemicalGroup->description }}" class="form-control form-control-sm" placeholder="Descrição">
                                @if($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="note" value="{{old('note') ?? $chemicalGroup->note }}" class="form-control form-control-sm" placeholder="Nota">
                            </div>
                            ...
                            <div>
                                ...
                                @else
                                    <div class="form-group">
                                        <label>Ativo: {{$chemicalGroup->in_use}} </label>
