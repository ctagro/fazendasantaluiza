                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Editar Classe Toxicológica</h4>
                        </div>
                    </div>

                    <div class="card-body">
                
                        <form action="{{route('toxicologicalClass.update' ,[ 'toxicologicalClass' => $toxicologicalClass->id ])}}" method="POST"  enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
