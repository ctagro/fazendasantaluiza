            ...
            <div class="col">
              ...
              <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{old('name') ?? $toxicologicalClass->name }}" class="form-control form-control-sm" placeholder="Nome">
                                @if($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="description" value="{{old('name') ?? $toxicologicalClass->description }}" class="form-control form-control-sm" placeholder="Descrição">
                                @if($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="note" value="{{old('note') ?? $toxicologicalClass->note }}" class="form-control form-control-sm" placeholder="Nota">
                            </div>
                            ...
                            <div>
                                ...
                                @else
                                    <div class="form-group">
                                        <label>Ativo: {{$toxicologicalClass->in_use}} </label>
