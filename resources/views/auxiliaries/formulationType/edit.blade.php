                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Editar Tipo de Formulação</h4>
                        </div>
                    </div>

                    <div class="card-body">
                
                        <form action="{{route('formulationType.update' ,[ 'formulationType' => $formulationType->id ])}}" method="POST"  enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
