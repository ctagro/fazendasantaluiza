                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Cadastro de Modo de aplicação</h4>
                        </div>
                    </div>

                    <div class="card-body">
                
                        <form  action="{{ route('applicationMode.store') }}" method="POST" enctype="multipart/form-data" class="col-12 was-validated">
                            @method('POST')
                            @csrf
