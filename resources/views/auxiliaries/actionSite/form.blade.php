            ...
            <div class="col">
              ...
              <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{old('name') ?? $actionSite->name }}" class="form-control form-control-sm" placeholder="Nome">
                                @if($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="description" value="{{old('name') ?? $actionSite->description }}" class="form-control form-control-sm" placeholder="Descrição">
                                @if($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="note" value="{{old('note') ?? $actionSite->note }}" class="form-control form-control-sm" placeholder="Nota">
                            </div>
                            ...
                            <div>
                                ...
                                @else
                                    <div class="form-group">
                                        <label>Ativo: {{$actionSite->in_use}} </label>
